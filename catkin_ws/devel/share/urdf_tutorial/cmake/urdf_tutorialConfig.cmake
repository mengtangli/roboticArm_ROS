...
if("TRUE" STREQUAL "TRUE")
  set(urdf_tutorial_SOURCE_PREFIX /home/eeit/roboarm/catkin_ws/src/urdf_tutorial)
  set(urdf_tutorial_DEVEL_PREFIX /home/eeit/roboarm/catkin_ws/devel)
  ...
  set(urdf_tutorial_INSTALL_PREFIX /home/eeit/roboarm/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'urdf_tutorial' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'eeit <eeit@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'urdf_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eeit/roboarm/catkin_ws/src/urdf_tutorial/${idir}'.  Ask the maintainer 'eeit <eeit@todo.todo>' to fix it.")
    endif()
