...
if("TRUE" STREQUAL "TRUE")
  set(MYBOT_description_SOURCE_PREFIX /home/eeit/roboarm/catkin_ws/src/MYBOT_description)
  set(MYBOT_description_DEVEL_PREFIX /home/eeit/roboarm/catkin_ws/devel)
  ...
  set(MYBOT_description_INSTALL_PREFIX /home/eeit/roboarm/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'MYBOT_description' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Dave Coleman <davetcoleman@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'MYBOT_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eeit/roboarm/catkin_ws/src/MYBOT_description/${idir}'.  Ask the maintainer 'Dave Coleman <davetcoleman@gmail.com>' to fix it.")
    endif()
