...
(cl:defmethod cl:initialize-instance :after ((m <num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_tut-msg:<num> is deprecated: use ros_tut-msg:num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_tut-msg:num-val is deprecated.  Use ros_tut-msg:num instead.")
  (num m))
