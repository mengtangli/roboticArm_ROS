...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<NavigatorStates>)))
  ...
  "5745df78c997599ee33f1055631024a9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'NavigatorStates)))
  "Returns md5sum for a message object of type 'NavigatorStates"
  "5745df78c997599ee33f1055631024a9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<NavigatorStates>)))
  ...
  (cl:format cl:nil "# used when publishing multiple navigators~%string[]         names~%NavigatorState[] states~%~%================================================================================~%MSG: baxter_core_msgs/NavigatorState~%# buttons~%string[] names~%bool[] buttons~%~%# wheel position~%uint8   wheel~%~%# true if the light is on, false if not~%# lights map to button names~%bool[] lights~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'NavigatorStates)))
  "Returns full string definition for message of type 'NavigatorStates"
  (cl:format cl:nil "# used when publishing multiple navigators~%string[]         names~%NavigatorState[] states~%~%================================================================================~%MSG: baxter_core_msgs/NavigatorState~%# buttons~%string[] names~%bool[] buttons~%~%# wheel position~%uint8   wheel~%~%# true if the light is on, false if not~%# lights map to button names~%bool[] lights~%~%~%"))
